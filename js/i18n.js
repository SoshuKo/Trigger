(() => {
  ...
  function loadV77() {
    if (!document.querySelector('link[data-v77]')) { const l=document.createElement('link'); l.rel='stylesheet'; l.href='v77-features.css?v=108'; l.dataset.v77='1'; document.head.appendChild(l); }
    if (!document.querySelector('link[data-simulation-v102]')) { const l=document.createElement('link'); l.rel='stylesheet'; l.href='v102-simulation-dashboard.css?v=108'; l.dataset.simulationV102='1'; document.head.appendChild(l); }
    if (!document.querySelector('script[data-v77]')) { const s=document.createElement('script'); s.src='js/v77-features.js?v=108'; s.defer=true; s.dataset.v77='1'; document.head.appendChild(s); }
    if (!document.querySelector('script[data-simulation-v102]')) { const s=document.createElement('script'); s.src='js/simulation-dashboard-v102.js?v=108'; s.defer=true; s.dataset.simulationV102='1'; document.head.appendChild(s); }
    document.querySelectorAll('.version-badge').forEach(el=>el.textContent='VERSION 108');
  }
